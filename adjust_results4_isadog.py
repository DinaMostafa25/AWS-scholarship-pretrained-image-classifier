...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        # step0 : - Reads in dognames from first line in file
        ...
        while line != "":
            ...
            # step1 : -Process line by striping newline from line
            line = line.rstrip()
            
           
            # step2: - adds dogname(line) to dogsnames_dic if it doesn't already exist 
            # in the dogsnames_dic dictionary and if exist print warning
            if line in dognames_dic:
                print('WARNING!!!!, repeated dog names')
            else:
                dognames_dic[line]=1
            # step3 : -Reads in next line in file to be processed with while loop
